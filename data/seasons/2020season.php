...
include_once $_SESSION['data_dir'] . "/shows/$season_year/doublewide.php";
include_once $_SESSION['data_dir'] . "/shows/$season_year/liveatthepo.php";
include_once $_SESSION['data_dir'] . "/shows/$season_year/ongoldenpond.php";
include_once $_SESSION['data_dir'] . "/shows/$season_year/wonka_jr.php";
?>
